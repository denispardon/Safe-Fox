...
<body style="opacity:0;transition:.5s;">
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header__logo">
                ...
                <nav class="nav">
                    <a href="#" id="open_sign_in" class="nav__link_sign">Вход</a>
                    <a href="#" id="open_sign_up" class="nav__link_reg">Регистрация</a>
                </nav>
   ...
   ?>
    ...
    <div class="intro">
        <div class="container">
            <div class="intro__inner">
                ...
                <div class="intro__text"  data-aos="fade-in" data-aos-delay="500">Рассказываем <b class="intro__textes">“цифровым туземцам”<br>об особенностях цифрового мира<br>и правилах безопасности</b></div>
                
                <div class="intro__btn" data-aos="zoom-in" data-aos-delay="200">
            ...
            <div class="info">
                ...
                <div class="info__item">
                    <a class="info__link" href="#kiber">
                        ...
                        <div class="info__text">Защита от фейков</div>
                    </a>
                </div>
            </div>
        </div><!-- ./Container -->
    ...
    <div class="project">
        <div class="container">
            ...
            <div class="project__item">
                ...
                <div class="project__subtitle" data-aos="fade-in"><b>Выявляем фейки:</b> отражаем правду российской и мировой истории.</div>
            </div>
            ...
            <div class="project__item">
                ...
                <div class="project__subtitle" data-aos="fade-in">Защита юного поколения от лжи, <b>только правда и факты</b></div>
            </div>
            ...
            <div class="project__item">
                ...
                <div class="project__subtitle" data-aos="fade-in"><b>Продвинутая безопасность:</b> как защитить себя от фейков.</div>
            </div>
    ...
    <div class="kiber">
        <div class="container">
            <div class="kiber__suptitle" data-aos="fade-up">Защита от <span class="kiber__subtitle">Фейков</span></div>

            <div class="kiber__item">
                <div class="kiber__img">
                    <img class="kiber__img" src="assets/img/Vector.png" data-aos="fade-in" alt="">
                </div>
                <div class="kiber__text" data-aos="fade-in"><b>Читайте новости целиком,</b> а не только её заголовок.</div>
            </div>
            ...
            <div class="kiber__item">
                ...
                <div class="kiber__text" data-aos="fade-in"><b>Изучите источник новости:</b> данные о портале — регистрацию, <br> состав редакции, адрес URL.</div>
            </div>
            ...
            <div class="kiber__item">
                ...
                <div class="kiber__text" data-aos="fade-in"><b>Уточните первоисточник.</b></div>
            </div>
            ...
            <div class="kiber__item">
                ...
                <div class="kiber__text" data-aos="fade-in"><b>Язык публикации:</b> факты в новости - нейтральны, без эмоциональных <br> призывов и оценочных высказываний автора</div>
            </div>
            ...
            <div class="kiber__item">
                ...
                <div class="kiber__text" data-aos="fade-in"><b>Не доверяйте фото и видео.</b>
                    <br><b>Поиск информации в других источниках.</b>
                    </div>
            </div>
            ...
            <div class="kiber__item">
                ...
                <div class="kiber__text" data-aos="fade-in"><b>Внимательность в социальных сетях.</b></div>
            </div>
   ...
   <div class="footer">
        <div class="container">
            <div class="footer__logo">
                <img class="footer__img" src="assets/img/logo.png" data-aos="flip-left" data-aos-delay="600" alt="">
            </div>
            ...
            <div class="footer__test" data-aos="zoom-in" data-aos-delay="200">
